...
namespace LudumDare57.Entities
{
    internal class Enemy : Sprite
    {
        ...
        public Enemy(Texture2D Texture, Vector2 Position, int Width, int Height, Tilemap Map) : base(Texture, Position, Width, Height)
        {
            _map = Map;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            switch (_currentLevel)
            {
                ...
                case 2:
                    ...
                    spriteBatch.Draw(Texture, new Rectangle(Global.ResX - Width, Rect.Y, Width, Height), _sourceRectangle, Color.White);
                    break;
        ...
        private void HandleGoblinAttack(GameTime gameTime)
        {
            if (_animationElapsedTime >= ANIMATION_TIME || _animationElapsedTime == 0)
            {
                ...
                {
                    _projectiles.Add(new Projectile(Texture, Position, Width, Height, _projectileSourceRenctangle));
                    _projectiles.Add(new Projectile(Texture, new Vector2(Global.ResX - Width, Rect.Y), Width, Height, _projectileSourceRenctangle));
                }
            }
        }
        ...
        private void LevelIsChanged(int changedTo, Rectangle playerRectangle)
        {
            ...
            switch (_currentLevel)
            {
                ...
                case 0:
                    _devilAnimationIteration = 0;
                    Position.X = Global.ResX / 2 - Width / 2;
                    Position.Y = Global.ResY / 2 - Height / 2;
                    break;
